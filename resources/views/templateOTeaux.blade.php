            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    ...
                    <div class="quick-contact-icons d-flex">
                        ...
                        <div class="text">
                            <span class="h4 d-block">DOUALA, Cameroun</span>
                            <span class="caption-text">OTeaux engeneering BP 10311, Rue Bernabe Douala-Akwa</span>
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="quick-contact-icons d-flex">
                        ...
                        <div class="text">
                            <span class="h4 d-block">oteauxsarl@hotmail.com</span>
                    ...
                    <div s class="mr-auto">
                        <nav  class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                                <li class="active">
                                    <a href="/OTEAUX" class="nav-link text-left">Accueil</a>
                                </li>
                                <li>
                                    <a href="/Assainissement" class="nav-link text-left">Assainissement</a>
                                </li>
                                <li>
                                    <a href="/BTP" class="nav-link text-left">BTP</a>
                                </li>
                                <li>
                                    <a href="/Climatisation" class="nav-link text-left">Climatisation</a>
                                </li>
                                <li>
                                    <a href="/Plomberie" class="nav-link text-left">Plomberie</a>
                                </li>
                                <li>
                                    <a href="/Electricité" class="nav-link text-left">Electricité</a>
                                </li>
                                <li><a href="/Négociation" class="nav-link text-left">Négoce</a></li>
...
@yield('content')
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <h3 class="footer-heading"><span>Notre entreprise</span></h3>
